...
/**
 * 
 * @Class Name   : AbstractInfinispanConfig.java
 * @Description  : @Configuration, @EnableCaching
 * @Modification :
 * @author       : gmind7 <gmind7@gmail.com>
 * @since        : 2013. 12. 30.
 */
public abstract class AbstractInfinispanConfig {
	...
	/**
	 * @Bean
	 * @return this.infinispanCacheManagerFactory();
	 */
	public abstract SpringRemoteCacheManagerFactoryBean cacheManager();
